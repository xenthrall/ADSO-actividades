...
return [
    ...
    */
    ...
    'classes_brand_text' => 'text-ligth',
    'classes_content_wrapper' => '',
    'classes_content_header' => 'text-success',
    'classes_content' => '',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Inicio',
            'url' => '/',
            'icon' => 'fas fa-fw fa-home fa-lg',
        ],
        [
            'text' => 'Marcas',
            'url' => 'marca/index',
            'icon' => 'fas fa-fw fa-tags fa-lg',
        ],
        [
            'text' => 'Categorias',
            'url' => 'categoria/index',
        ...
        [
            'text' => 'Estado',
            'url' => 'estado/index',
            'icon' => 'fas fa-flag fa-lg',
        ],
        [
            'text' => 'clientes',
            'url' => 'cliente/index',
            'icon' => 'fas fa-fw fa-users fa-lg',
        ],
        [
            'text' => 'Productos',
            'url' => 'producto/index',
            'icon' => 'fas fa-fw fa-store fa-lg',
        ],
        [
            'text' => 'Facturas',
            'url' => 'factura/index',
            'icon' => 'fas fa-fw fa-file-invoice fa-lg',
        ],
        [
            'text' => 'Detalle de Facturas',
            'url' => 'detalle/index',
            'icon' => 'fas fa-fw fa-file-invoice-dollar fa-lg',
        ],
